---
title: 法国学生居留办理与续签指南
description: 抵法后验证 VLS-TS、续办学生居留、准备 ANEF 材料和处理补件的实用指南。
---

# 办理居留

!!! abstract "速览"
    * **第一年动作**：持长期学生签证入境后，最迟 3 个月内在 ANEF 完成 VLS-TS 验证并支付电子印花税。→ [查看首年验证](#residence-first-year)
    * **后续年份动作**：居留到期前 2～3 个月在 ANEF 提交续办申请，不要等到到期当天。→ [查看续办时间](#residence-renewal)
    * **官方入口**：使用 [Étrangers en France / ANEF](https://administration-etrangers-en-france.interieur.gouv.fr/)。→ [查看首年验证](#residence-first-year)
    * **必备材料**：护照与签证页、近 3 个月住房证明、新学年注册或在读证明、成绩单、资金证明和 e-photo 代码。→ [查看材料清单](#residence-materials)
    * **办理避坑**：住房证明不能超过 3 个月；换专业或重读需附解释信；提交回执不等于可以出境。→ [查看退件原因](#residence-pitfalls)

![学生居留时间线](../../../assets/admin/residence/residence-timeline.svg)
...
## 第一年：验证 VLS-TS {#residence-first-year}
