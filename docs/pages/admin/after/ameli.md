...
!!! abstract "速览"
    * **办理时限**：抵法入学并拿到法国银行 RIB 后尽快办理，建议入学第一周内启动。→ [查看申请流程](#ameli-process)
    * **官方入口**：使用 [etudiant-etranger.ameli.fr](https://etudiant-etranger.ameli.fr)，这是留学生专属通道。→ [查看入口说明](#ameli-entry)
    * **必备材料**：护照、有效学生签证或居留证明、当年在读证明、法国银行 RIB、出生公证海牙认证（Apostille，旧版双认证亦有效）或法院宣誓翻译件。→ [查看材料清单](#ameli-materials)
    * **办理避坑**：材料须为边角完整的原色高清扫描件；未收到 Carte Vitale 前，可凭 **Attestation de droits** 享受报销。→ [查看避坑指南](#ameli-pitfalls)
...
## 3. 申请材料清单（最核心装备） {#ameli-materials}

虽然不同省份/个人情况可能会有细微差别（比如可能被要求重新提交某一份翻译），但**通常必备**的是以下 5 项。请在开始申请前逐个打勾确认：

1. **身份证明**：护照首页（或其它包含照片和身份信息的有效证件）
2. **出生证明**：建议准备带父母详细信息的**出生公证海牙认证**（Apostille，持有此前办妥的旧版双认证亦有效）或**法国上诉法院宣誓翻译件**（常见退件重灾区，务必确保翻译达标）。
...
一般会分为以下几个核心版块：
- **个人基本信息**
- **父母姓名**：**强烈建议完全照抄出生公证海牙认证/旧版双认证（或宣誓译文）上的法文拼写**。字母顺序、拼音间断、大小写如有出入，极易被系统判定为两套不同的信息而遭退回。
...
## 7. 避坑指南：中国新生高频“触雷”区 {#ameli-pitfalls}

!!! warning "雷区 1：出生证明不被认可"
    - 只提交了“无父母信息”的简版出生公证，这不符合法国开户要求。
    - 翻译件未经过法国正规途径认可。自 2023 年底中国加入海牙公约后，建议在国内办理**海牙附加证明书（Apostille）**（此前已办理的旧版外交部+使馆双认证依然有效），或者来法国后找当地**上诉法院宣誓翻译员**完成法定翻译。
