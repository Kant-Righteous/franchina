...
图卢兹是法国最大的大学城之一，拥有超过 **12 万名在校学生**，学术氛围浓厚。
...
!!! tip "大学图书馆"
    各大学均设有图书馆（BU），**凭学生卡免费使用**，通常开放至 20:00 甚至 22:00。考试季推荐去 **BU Arsenal**（UT1）或 **BU Sciences**（UT3），环境安静，座位充足。
...
!!! tip "网购与学生省钱工具"
    ...
    - **[Too Good To Go](https://toogoodtogo.fr/)**：环保临期食品盲盒 App，下午或傍晚常可以 3~5€ 抢购附近 Paul 面包房、Sushi 餐厅或 Carrefour 的超值盲盒。
    - **[UNiDAYS](https://www.myunidays.com/) / [StudentBeans](https://www.studentbeans.com/)**：使用学校邮箱即可验证，享受 Apple 教育优惠、Nike、ASOS、Samsung 等品牌 10%~20% 学生专享折扣。
    - **[一分钱 (ECENTIME)](https://www.ecentime.com/)**：欧洲华人打折导购与好物推荐社区。
    - **Amazon.fr**：日用品与电子产品首选，大学生可试用 6 个月 Prime Student。
...
图卢兹有不少中餐馆和亚洲餐厅，主要聚集在：

- **市中心 / Capitole 周边**：各类亚洲快餐和中餐馆
- **Arnaud Bernard 区域**：多元文化美食聚集地
- **Jean-Jaurès 附近**：也有一些亚洲餐厅
...
- **奥古斯坦博物馆（Musée des Augustins）**：中世纪至现代艺术珍品
- **图卢兹自然历史博物馆（Muséum de Toulouse）**：位于皇家植物园内，适合周末散步
- **太空城（Cité de l'Espace）**：航天迷必去
- **Les Abattoirs**：现当代艺术博物馆，常有不错的展览
- **卡皮托勒剧院（Théâtre du Capitole）**：歌剧和芭蕾演出

!!! tip "文化福利"
    许多博物馆**每月第一个周日免费**开放。此外，**26 岁以下**持学生证可享受大量免费或半价优惠。

### 节日与活动

- **Rio Loco 音乐节**（6 月）：加龙河畔露天音乐节，免费 + 收费演出
- **Toulouse d'Été**（7–8 月）：夏季城市文化节
- **Fête de la Violette**（2 月）：紫罗兰节，图卢兹特色
- **Marathon de Toulouse**（10 月）：图卢兹马拉松
- **Marché de Noël**（12 月）：圣诞集市，在 Capitole 广场

### 体育

- **Stade Toulousain**（橄榄球）：法国最成功的橄榄球俱乐部，主场 Ernest-Wallon 球场，建议去现场感受一次法式橄榄球的热烈氛围！
- **Toulouse FC**（足球）：法甲球队，主场 Stadium de Toulouse
- **环法自行车赛**：多次途经图卢兹
...
日常就医流程、家庭医生申报、远程问诊（Doctolib / Medadom）和医保报销等全法通用内容，见[医疗健康指南](../life/health.md)；紧急电话与夜间上门医生（SOS Médecins）见[紧急求助指南](../help/emergency.md)。图卢兹本地资源如下：
...
急诊按病情危急程度分诊（Triage）接诊而非先来后到，非危重症状可能等待数小时；危及生命时直接拨打 **15** 或 **112**。

---

## 学生一站式综合服务（Welcome Desk）

图卢兹大学联盟在市中心设有专门面向国际学生的综合服务大厅 **Welcome Desk**：

- **地理位置**：位于 Palais de Justice 附近（*41 allées Jules Guesde, 31000 Toulouse*），地铁 B 线或电车 T1/T2 Palais de Justice 站出站即达。
- **核心驻点柜台**：
  - **CAF 房补柜台**：现场核验房补申请材料，解决各类 APL 疑难问题；
  - **居留办理指导（Préfecture 专柜）**：协助学生提交初次居留申请或长居续签（Titre de séjour）；
  - **学业与生活指引**：提供法律咨询、勤工俭学兼职信息、职业规划及寻找住房协助。

---

## 财务相关

银行卡盗刷应急处置、留学生年度报税（Déclaration d'impôts）等财务安全内容，见[银行开户指南](../life/finance/bank.md)。
...
!!! tip "融入当地华人圈"
    - **微信群**：图卢兹本地有各类华人群与二手置换群，可找学长学姐邀请入群。
    - **[图卢兹学联](cssa.md)**：图卢兹中国学者学生联合会（UCECF-ST）官方驻地，提供新生咨询、迎新讲座、春晚庆典与生活互助。
    - **海外邮箱建议**：部分国内邮箱可能出现境外官方邮件过滤或拦截情况，建议注册使用 **Gmail** 或学校统一分配的 Webmail 处理日常行政事务。
...
<p style="font-size: 0.95em; color: #999; text-align: center; margin-top: 2rem;">本页内容仅供参考，价格和信息可能随时变动，请以各官方网站公布的最新信息为准。</p>
